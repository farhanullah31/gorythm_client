// Mission detail pages – IQ, EQ, and PhQ
...
const MISSION_RING = [
  { key: 'phq', label: 'Physical Health Quotient', path: '/mission/phq' },
  { key: 'iq', label: 'Intellectual Quotient', path: '/mission/iq' },
  { key: 'eq', label: 'Emotional Quotient', path: '/mission/eq' },
];
  ...
  <div className="mission-page scheme_dark">
    <div className="mission-page-inner">
      ...
      <div className="mission-page-body">
        {description ? <p className="mission-page-description">{description}</p> : null}
        {points && (
...
export const IqMissionPage = () => (
  <MissionPageLayout
    ...
    description=""
    points={[
      'Critical Thinking: Analyze deeply before deciding. Examine your assumptions and arrive at conclusions that truly hold up, rather than settling for what simply feels right.',
      'Pattern Recognition: See connections others miss across various disciplines and contexts. The mind that finds structure in complexity is the mind that leads.',
...
export const EqMissionPage = () => (
  <MissionPageLayout
    ringKey="eq"
    subtitle="How We Support Growth"
    title="EQ — Emotional Quotient: How you feel, connect, and lead."
    description="Emotional intelligence is not softness. It is precision. We develop self-awareness, empathy, emotional regulation, and the ability to act with clarity under pressure. Our approach is confined in resilience, moral integrity, and a sense of purpose that holds steady when circumstances do not. Character is not built in comfort. It is built in the moments that test it."
    points={[
      'Self-Awareness: Know your triggers, patterns, and emotional landscape. The person who truly understands himself is rarely controlled by circumstances.',
      ...
      'Moral Integrity: Stay aligned with your values, especially when no one is watching. Consistency between belief and behavior is the foundation of a trustworthy character.',
    ]}
  />
);

// PhQ — Physical Health Quotient
export const PhqMissionPage = () => (
  <MissionPageLayout
    ringKey="phq"
    subtitle="How We Support Growth"
    title="PhQ — Physical Health Quotient"
    description="How we move, recover, and endure. Our body is not separate from our mind; rather it is the foundation of it. We practice discipline, vitality, and daily habits necessary to fuel our highest ambitions over the long run. True physical health is rooted in somatic awareness, strategic recovery, and a deep understanding of how our physical state dictates our mental and emotional resilience. The body is a vessel. We should treat it with ultimate respect."
    points={[
      ...
      'Strategic Recovery: Rest is not a luxury, nor is it laziness. It is the active and non-negotiable foundation of high performance.',
